           ...
           <div className="card">
               ...
               <ul className="list-group">
                   <li className="list-group-item">
                       <Link to="/admin/categories" className="nav-link text-info">Create Categories</Link>
                   </li>
                   <li className="list-group-item">
                       <Link to="/admin/create/category" className="nav-link text-info">Manage Categories</Link>
                   </li>
                   <li className="list-group-item">
    ...
    const adminRightSide = () => {
        return(
           <div className="card mb-4">
               ...
               <ul className="list-group">
                   <li className="list-group-item">
                       <span className="badge bage-succes mr-2">Name:</span>{name}
                   </li>
                   <li className="list-group-item">
                       <span className="badge bage-succes mr-2">Email:</span>{email}
                   </li>
                   <li className="list-group-item">
